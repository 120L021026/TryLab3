...
public class DinnerOrderApp
{
	...
	voterMap.put(voter1, 3.0);
	voterMap.put(voter2, 2.0);
	voterMap.put(voter3, 1.0);
	voterMap.put(voter4, 2.0);
	...
	VoteItem<Dish> voteItem16=new VoteItem<>(dish6, "Like");
	...
	VoteItem<Dish> voteItem25=new VoteItem<>(dish5, "Dislike");
	...
	VoteItem<Dish> voteItem41=new VoteItem<>(dish1, "Like");
