...
public class ChangeDinnerOrderStatisticsTest
{
    @Test
    public void testChangeDinnerOrderStatisticsTest()
    {
	// 创建DinnerOrder类
	...
	VoteItem<Dish> voteItem16=new VoteItem<>(dish6, "Dislike");
	...
	VoteItem<Dish> voteItem45=new VoteItem<>(dish5, "Dislike");
	...
	Map<Dish, Double> retMap1=new HashMap<>();
	retMap1.put(dish1, 4.0);
	retMap1.put(dish2, 0.0);
	retMap1.put(dish3, 6.0);
	retMap1.put(dish4, 4.0);
	retMap1.put(dish5, 2.0);
	retMap1.put(dish6, 4.0);
	
	// 测试statistics()方法
	assertEquals(retMap1, dinnerOrderPoll.getStatistics());
	
	SelectionStrategy<Dish> selectionStrategy=new DinnerOrderSelection<>();
	dinnerOrderPoll.selection(selectionStrategy);
	
	Map<Dish, Double> retMap2=new HashMap<>();
	retMap2.put(dish1, 4.0);
	retMap2.put(dish3, 6.0);
	retMap2.put(dish4, 4.0);
	retMap2.put(dish6, 4.0);
	
	// 测试selection()方法
	assertEquals(retMap2, dinnerOrderPoll.getResults());
    }
}
